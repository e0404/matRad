...
appdata = [];
appdata.lastValidTag = 'vmcFlag';

h33 = uicontrol(...
'Parent',h12,...
'FontUnits',get(0,'defaultuicontrolFontUnits'),...
'Units','normalized',...
'String','use MC (VMC++) dose calculations',...
'Style','radiobutton',...
'Position',[0.553984575835475 0.840304182509506 0.344473007712082 0.140684410646388],...
'BackgroundColor',[0.501960784313725 0.501960784313725 0.501960784313725],...
'Callback',@(hObject,eventdata)matRadGUI('vmcFlag_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Tag','vmcFlag',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
appdata = [];
appdata.lastValidTag = 'uiTable';
appdata.PropertyMetaData = {  {  'DataPropertyDimension' 'DataPropertyConditionedDimension' 'DataPropertySource' 'BackgroundColorPropertyDimension' 'ColumnNameTyped' 'RowNameTyped' } {  [4 2] [4 9] 'DataDefault' [2 3] {  'VOI name' 'VOI type' 'priority' 'obj. / const.' 'penalty' 'dose' 'EUD' 'volume' 'robustness' } {  blanks(0) blanks(0) blanks(0) blanks(0) } } };

h72 = uitable(...
'Parent',h71,...
'Units','normalized',...
'BackgroundColor',[0.501960784313725 0.501960784313725 0.501960784313725;0.8 0.8 0.8],...
'ColumnName',{  'VOI name'; 'VOI type'; 'priority'; 'obj. / const.'; 'penalty'; 'dose'; 'EUD'; 'volume'; 'robustness' },...
'ColumnWidth',{  95 65 42 120 50 45 30 50 65 },...
'Data',{  blanks(0) blanks(0) blanks(0) blanks(0) blanks(0) blanks(0) blanks(0) blanks(0) blanks(0); blanks(0) blanks(0) blanks(0) blanks(0) blanks(0) blanks(0) blanks(0) blanks(0) blanks(0); blanks(0) blanks(0) blanks(0) blanks(0) blanks(0) blanks(0) blanks(0) blanks(0) blanks(0); blanks(0) blanks(0) blanks(0) blanks(0) blanks(0) blanks(0) blanks(0) blanks(0) blanks(0) },...
'Position',[0.00753012048192771 0.0575916230366492 0.930722891566265 0.921465968586387],...
'ColumnEditable',mat{11},...
'ColumnFormat',{  [] [] [] [] [] [] [] [] [] },...
'CellEditCallback',@(hObject,eventdata)matRadGUI('uiTable_CellEditCallback',hObject,eventdata,guidata(hObject)),...
'CellSelectionCallback',@(hObject,eventdata)matRadGUI('uiTable_CellSelectionCallback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'TooltipString','table for setting objectives',...
'ButtonDownFcn',@(hObject,eventdata)matRadGUI('uiTable_ButtonDownFcn',hObject,eventdata,guidata(hObject)),...
'Tag','uiTable',...
'UserData',[],...
'FontName','Helvetica',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
appdata = [];
appdata.lastValidTag = 'btnuiTableAdd';
...
'Units','normalized',...
'String','+',...
'Position',[0.950301204819277 0.631284916201117 0.0391566265060241 0.184357541899441],...
'BackgroundColor',[0.8 0.8 0.8],...
'Callback',@(hObject,eventdata)matRadGUI('btnuiTableAdd_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Tag','btnuiTableAdd',...
'FontSize',12,...
'FontWeight','bold',...
...
appdata = [];
appdata.lastValidTag = 'btnuiTableDel';
...
'Units','normalized',...
'String','-',...
'Position',[0.950301204819277 0.435754189944134 0.0391566265060241 0.17877094972067],...
'BackgroundColor',[0.8 0.8 0.8],...
'Callback',@(hObject,eventdata)matRadGUI('btnuiTableDel_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Tag','btnuiTableDel',...
'FontSize',14,...
'FontWeight','bold',...
...
appdata = [];
appdata.lastValidTag = 'btnTableSave';
...
'Units','normalized',...
'String','save',...
'Position',[0.941265060240964 0.0949720670391062 0.0557228915662651 0.223463687150838],...
'BackgroundColor',[0.8 0.8 0.8],...
'Callback',@(hObject,eventdata)matRadGUI('btnTableSave_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Tag','btnTableSave',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'CameraViewAngle',6.60861036031192,...
'CameraViewAngleMode',get(0,'defaultaxesCameraViewAngleMode'),...
'PlotBoxAspectRatio',[0.997425997425998 1 0.997425997425998],...
'PlotBoxAspectRatioMode',get(0,'defaultaxesPlotBoxAspectRatioMode'),...
'FontName','CMU Serif',...
'Colormap',[0 0 0.5625;0 0 0.625;0 0 0.6875;0 0 0.75;0 0 0.8125;0 0 0.875;0 0 0.9375;0 0 1;0 0.0625 1;0 0.125 1;0 0.1875 1;0 0.25 1;0 0.3125 1;0 0.375 1;0 0.4375 1;0 0.5 1;0 0.5625 1;0 0.625 1;0 0.6875 1;0 0.75 1;0 0.8125 1;0 0.875 1;0 0.9375 1;0 1 1;0.0625 1 1;0.125 1 0.9375;0.1875 1 0.875;0.25 1 0.8125;0.3125 1 0.75;0.375 1 0.6875;0.4375 1 0.625;0.5 1 0.5625;0.5625 1 0.5;0.625 1 0.4375;0.6875 1 0.375;0.75 1 0.3125;0.8125 1 0.25;0.875 1 0.1875;0.9375 1 0.125;1 1 0.0625;1 1 0;1 0.9375 0;1 0.875 0;1 0.8125 0;1 0.75 0;1 0.6875 0;1 0.625 0;1 0.5625 0;1 0.5 0;1 0.4375 0;1 0.375 0;1 0.3125 0;1 0.25 0;1 0.1875 0;1 0.125 0;1 0.0625 0;1 0 0;0.9375 0 0;0.875 0 0;0.8125 0 0;0.75 0 0;0.6875 0 0;0.625 0 0;0.5625 0 0],...
'ColormapMode',get(0,'defaultaxesColormapMode'),...
...
'Color',[0 0 0],...
'ColorMode','auto',...
'Position',[0.500000554361651 1.0034083011583 0.5],...
'PositionMode','auto',...
'String',blanks(0),...
'Interpreter','tex',...
'Rotation',0,...
...
'Color',[0.15 0.15 0.15],...
'ColorMode','auto',...
'Position',[0.500000476837158 -0.036402832047206 0],...
'PositionMode','auto',...
'String',blanks(0),...
'Interpreter','tex',...
'Rotation',0,...
...
elseif local_isInvokeHGCallback(gui_State, varargin{:})
    % MATRADGUI('CALLBACK',hObject,eventData,handles,...)
    gui_Create = false;
else
    % MATRADGUI(...)
