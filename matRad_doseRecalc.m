...
if recalc.pln.minGantryAngleRes ~= pln.minGantryAngleRes
    ...
    recalc.stf = matRad_generateStf(ct,cst,recalc.pln);
    ...
    %recalc.resultGUI.wDao = recalc.apertureInfo.bixelWeights;
    
    %recalc.resultGUI.physicalDose = reshape(dij.physicalDose{1}*recalc.resultGUI.w,dij.dimensions);
end
