...
resultGUI = matRad_calcCubes(ones(dij.totalNumOfBixels,1),dij); %matRad_fluenceOptimization(dij,cst,pln);
...
%sqDev = sum(sum(sum(resultGUI.physicalDose_diff.^2)))%give out square deviation of MC and analytical dose
