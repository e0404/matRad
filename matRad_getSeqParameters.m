function [shapeInfo, shapeInfoVect] = matRad_getSeqParameters(Sequencing,stf,pln,visBool)
    ...
    % leaf positions can be extracted from the shapes created in Sequencing
        for m=1:Sequencing.beam(i).numOfShapes
            ...
            if visBool
                ...
                matRad_visSingleShape(shapeMap,leftLeafPos,rightLeafPos,...
...
[shapeInfoVect, shapeInfo.addInfoVect, shapeInfo.limVect] = matRad_shapeInfo2Vect(shapeInfo);
