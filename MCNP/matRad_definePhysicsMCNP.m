function matRad_definePhysicsMCNP(fileID_C_rest, pln, binIntervals, simPropMCNP)
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% 
% call
%   matRad_definePhysicsMCNP(fileID_C_rest, pln)
%
% input
...
fprintf(fileID_C_rest, ['NPS' ' ' num2str(pln.propMCNP.numberParticles) '\n']);