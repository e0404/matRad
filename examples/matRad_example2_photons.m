...
% size of 5 x 5 mm in the isocenter plane.
...
figure;
title('original plan - fine beam spacing');
...
figure;
title('modified plan - coarse beam spacing');
...
figure;
title('fine beam spacing plan - coarse beam spacing plan');
