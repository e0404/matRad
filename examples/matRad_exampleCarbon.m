...
% (iii) how to inversely optimize the pencil beam intensities 
...
% The parameters alphaX and betaX depict the tissue's photon radio sensitivity  parameter of the linear quadratic model. These parameter
...
% objective for the target thereby equally penalizing over and underdosage.
cst{10,6}
...
stf.numOfRays
%%
% The following sub-structure stores the number of bixels/pencil beams per
...
% beam/ray geometry information. For illustration purposes we want to show the one-hundreds ray.
% Besides geometrical  information about the position and orientation of the ray, we can also 
