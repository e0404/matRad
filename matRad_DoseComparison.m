function [stackedbarDose,physDoseInDepth,RBExDcurve,RBEcurve] = matRad_DoseComparison(definedEnd,index,ct,ctCube,dij,resultGUI,add,LET_thres,k,displayComparison)
%
% call
