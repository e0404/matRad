...
%% export Plan
matRad_export_HITXMLPlan_modified('Liver007_Bix5',  pln, stf, resultGUI, 'backforth')  %500000 minNbParticles HIT Minimum für Patienten, minNrParticlesIES, scan path mode: 'stfMode', 'backforth','TSP' (very slow)

%% calc 4D dose
[resultGUI, delivery] = matRad_calc4dDose(ct, pln, dij, stf, cst, resultGUI,  'Liver007_Bix5_1'); %'LiverDS221_wc5555_3mmBixel_bf'); %TKUH005_test');  
