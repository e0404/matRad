...
pln.propDoseCalc.doseGrid.resolution.x = 20; % [mm]
pln.propDoseCalc.doseGrid.resolution.y = 20; % [mm]
pln.propDoseCalc.doseGrid.resolution.z = 20; % [mm]

% beam settings (ignore for brachy)
