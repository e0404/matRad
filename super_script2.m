...
cst{1, 6}{2}=DoseConstraints.matRad_MinMaxDose(0, 30, 1, 100);
...
%%
exportgraphics(hfPlan,'super_script2_plan.png');
exportgraphics(hFvals,'super_script2_vals.png');

exportgraphics(axObjVsIter,'super_script2_objVsIter.png');
exportgraphics(axObjVsTime,'super_script2_objVsTime.png');
exportgraphics(axViolVsIter,'super_script2_violVsIter.png');
exportgraphics(axViolVsTime,'super_script2_violVsTime.png');

exportgraphics(axSuperPlan,'super_script2_superPlan.png');
exportgraphics(axIpoptPlan,'super_script2_ipoptPlan.png');
exportgraphics(axDiffPlan,'super_script2_diffPlan.png');
exportgraphics(axDVHs,'super_script2_dvhs.png');

%%
close all;
save('super_script2.mat');
