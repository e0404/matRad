...
function test_getDistMtx
                ...
                assertEqualWithTolerance(funcDistanceMatrix.dist,verifyDistanceMatrix,0.1,'AbsTol')
...
function test_getThetMtx
                ...
                assertEqualWithTolerance(funcThetaMatrix,verifyThetaMatrix,0.1,'AbsTol')
...
function assertEqualWithTolerance(actual, expected, tolerance, message)

    
                assert(all(abs(actual(:) - expected(:)) < tolerance), message);
