...
function test_interp1Extrapolation
...
function test_interp1ExtrapolationNearest
xi = [1 2 3]';
yi = [1 2 3]';
x = [0 1.5 4]';
...
% First value is repeated value in x1, second value is different;
