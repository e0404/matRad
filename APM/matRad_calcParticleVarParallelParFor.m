function  [cst,resultGUI] =  matRad_calcParticleVarParallelParFor(ct,cst,stf,pln,dij,resultGUI,ix,param)
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for k = 1:numOmega
   ...
   if poolsize ~= pln.probOpt.numOfWorkers
      delete(gcp);
      parpool('local',pln.probOpt.numOfWorkers);     
   end
   parfor_progress(numel(ixSub));
