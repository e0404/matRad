...
% 
% call
%   matRad_exportDicomRtss(cst,ct,ctDicomMeta)
%
% input
%   cst:            matRad cst cell array
%   ct:             corresponding matRad ct struct
%   ctDicomMeta:    dicom meta information for ct (slices) as generated by
%                   the matRad_exportDicomCt function. Used to incorporate 
...
%Name
meta = matRad_assignDefaultMetaValue(meta,'StructureSetLabel','matRad_exported_cst');
meta = matRad_assignDefaultMetaValue(meta,'StructureSetName','matRad exported cst');
meta = matRad_assignDefaultMetaValue(meta,'ManufacturerModelName','matRad DicomExport');
...
meta = matRad_assignDefaultMetaValue(meta,'StructureSetDate',currDateStr);
meta = matRad_assignDefaultMetaValue(meta,'StructureSetTime',currTimeStr);
...
for i = 1:size(obj.cst,1)
    ...
    for c = 1:numel(contours)
        ...
        currCtSliceMeta = matRad_assignDefaultMetaValue(currCtSliceMeta,'SOPClassUID','1.2.840.10008.5.1.4.1.1.2');
