function jacob = matRad_daoJacobFunc_VMATdynamic(apertureInfoVec,apertureInfo,dij,cst,type,daoVec2ApertureInfo)
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
j_lfspd_t = -reshape(abs([leftLeafDiff rightLeafDiff])./ ...
