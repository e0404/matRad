...
dirMatRad = pwd;                                              % set the matRad root directory
...
mcc('-C','-o','matRad','-W','WinMain:matRad','-T','link:exe','-d',dirOut,...      
    '-R','-logfile,consoleOutput.log','-v',[dirMatRad filesep 'matRadGUI.m'],...
    '-a',[dirMatRad filesep 'dicomImport' filesep 'DKFZ_Logo.png'],...
    '-a',[dirMatRad filesep 'dicomImport' filesep 'matrad_logo.png'],...
    '-a',[dirMatRad filesep 'dicomImport' filesep 'hlutDefault.mat'],...
    '-a',[dirMatRad filesep 'photons_Generic.mat'],...
    '-a',[dirMatRad filesep 'protons_Generic.mat'],...
    '-a',[dirMatRad filesep 'carbon_Generic.mat'])
