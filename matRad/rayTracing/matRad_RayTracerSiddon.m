classdef matRad_RayTracerSiddon < matRad_RayTracer
    ...
    methods
        ...
        function [alphas,l,rho,d12,ix] = traceRays(this,...
            ...
            i(i<1) = 1;   i(i>this.numPlanes(1)-1) = this.numPlanes(1) - 1;
            j(j<1) = 1;   j(j>this.numPlanes(2)-1) = this.numPlanes(2) - 1;
            k(k<1) = 1;   k(k>this.numPlanes(3)-1) = this.numPlanes(3) - 1;
    ...
    methods (Access = protected)
        ...
        function alphas = computePlaneAlphas(this,sourcePoint,rayVec,dimMin,dimMax)
            ...
            for i = 1:3
                ...
                planeGrid(planeIx < dimMin(:,i) | planeIx > dimMax(:,i) | (planeIx == dimMin(:,i) & planeIx == dimMax(:,i)) | isnan(dimMin(:,i)) | isnan(dimMax(:,i))) = NaN;
