classdef (Abstract) matRad_PhantomVOIVolume < handle
    ...
    properties
        name
        type
        TissueClass = 1       % mh:ignore_style
        alphaX = 0.1000
        betaX = 0.0500
        Priority = 1          % mh:ignore_style
        Visible = 1           % mh:ignore_style
        visibleColor = [0 0 0]
        HU = 0
        offset = [0, 0, 0]    % center of objective
        coordType = 'voxel'   % 'voxel' or 'mm' - governs how dimensions and offset are interpreted
        objectives = {}
    ...
    methods
        ...
        function obj = matRad_PhantomVOIVolume(name, type, p)
            ...
            obj.HU = p.Results.HU;
            obj.coordType = p.Results.coordType;
    ...
    methods
        ...
        function set.coordType(obj, cType)
            obj.coordType = validatestring(cType, {'voxel', 'mm'});
        end
