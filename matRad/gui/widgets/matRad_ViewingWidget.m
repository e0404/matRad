...
%                         slice = round(get(handles.sliderSlice,'Value'));
        ...
        function matRadScrollWheelFcn(this,src,event)
            ...
            if matRad_cfg.isOctave
                %Octave unfortunately does provide the CurrentPoint for the last
                %click
                inWindow = true;
            else
              % Check Position
              ...
              inWindow = cursorPos(1) > viewerPos(1) && ...
                  cursorPos(1) < viewerPos(1) + viewerPos(3) && ...
                  cursorPos(2) > viewerPos(2) && ...
                  cursorPos(2) < viewerPos(2) + viewerPos(4);
            end
