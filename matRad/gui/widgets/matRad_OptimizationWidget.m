        ...
        function this = matRad_OptimizationWidget(handleParent)
            ...
            if nargin < 1
                handleParent = figure( ...
                                      ...
                                      'IntegerHandle', 'off', ...
                                      'Colormap', [0 0 0.5625; 0 0 0.625; 0 0 0.6875; 0 0 0.75; 0 0 0.8125; 0 0 0.875; ...
                                                   0 0 0.9375; 0 0 1; 0 0.0625 1; 0 0.125 1; 0 0.1875 1; 0 0.25 1; ...
                                                   0 0.3125 1; 0 0.375 1; 0 0.4375 1; 0 0.5 1; 0 0.5625 1; 0 0.625 1; ...
                                                   0 0.6875 1; 0 0.75 1; 0 0.8125 1; 0 0.875 1; 0 0.9375 1; 0 1 1; ...
                                                   0.0625 1 1; 0.125 1 0.9375; 0.1875 1 0.875; 0.25 1 0.8125; 0.3125 1 0.75; 0.375 1 0.6875; ...
                                                   0.4375 1 0.625; 0.5 1 0.5625; 0.5625 1 0.5; 0.625 1 0.4375; 0.6875 1 0.375; 0.75 1 0.3125; ...
                                                   0.8125 1 0.25; 0.875 1 0.1875; 0.9375 1 0.125; 1 1 0.0625; 1 1 0; 1 0.9375 0; ...
                                                   1 0.875 0; 1 0.8125 0; 1 0.75 0; 1 0.6875 0; 1 0.625 0; 1 0.5625 0; ...
                                                   1 0.5 0; 1 0.4375 0; 1 0.375 0; 1 0.3125 0; 1 0.25 0; 1 0.1875 0; ...
                                                   1 0.125 0; 1 0.0625 0; 1 0 0; 0.9375 0 0; 0.875 0 0; 0.8125 0 0; ...
    ...
    methods (Access = private)
            ...
            for i = 1:size(cst, 1)
                ...
                for j = 1:numel(cst{i, 6})
                    ...
                    h = uicontrol(cstPanel', 'Style', 'edit', ...
                                  ...
                                  'FontSize', matRad_cfg.gui.fontSize, ...
                                  'FontName', matRad_cfg.gui.fontName, ...
                                  'FontWeight', matRad_cfg.gui.fontWeight, 'BackgroundColor', matRad_cfg.gui.elementColor, ...
                                  'ForegroundColor', matRad_cfg.gui.textColor, 'TooltipString', 'Name', ...
                                  'Enable', 'inactive', ... %Disable editing of name atm
                                  'UserData', [i, 2], ...
                                  'Callback', @(hObject, eventdata)editCstParams_Callback(this, hObject, eventdata));
                    % Callback added, however, editing is disabled atm
                    ...
                    if (isa(cst{i, 6}{j}, 'matRad_DoseOptimizationFunction') && matRad_ispropCompat(cst{i, 6}{j}, 'robustness')) || ...
                            isfield(cst{i, 6}{j}, 'robustness')
                    ...
                    if isa(obj, 'DoseObjectives.matRad_DoseObjective')
                        ...
                        h = uicontrol(cstPanel, 'Style', 'edit', 'String', '----', 'Units', 'normalized', ...
                                      'Position', [xPos ypos(cnt) penaltyW objHeight], ...
                                      'FontSize', matRad_cfg.gui.fontSize, 'FontName', matRad_cfg.gui.fontName, ...
                                      'FontWeight', matRad_cfg.gui.fontWeight, 'BackgroundColor', matRad_cfg.gui.elementColor, ...
                                      'ForegroundColor', matRad_cfg.gui.textColor, 'Enable', 'off');
                    end
                    tmp_pos = get(h, 'Position');
                    xPos = xPos + tmp_pos(3) + fieldSep;

                    for p = 1:numel(obj.parameterNames)
                        %                             h = text('Parent',tmpAxes,'String',['| ' obj.parameterNames{p} ':'],...
                        %                                 'VerticalAlignment','middle','Units','normalized',...
                        %                                 'Position',[xPos ypos(cnt)+lineHeight/2],'Interpreter','tex',...
                        %                                 'FontWeight','normal',...
                        %                                 'FontSize',get(cstPanel,'FontSize'),'FontName',get(cstPanel,'FontName'),...
                        %                                 'FontUnits',get(cstPanel,'FontUnits'),...
                        ...
                        xPos = xPos + tmp_pos(3) + fieldSep;
                        % h = annotation(cstPanel,'textbox','String',obj.parameters{1,p},'Units','pix',...
                        %                'Position', [xPos ypos(cnt) 100 objHeight],'Interpreter','Tex');
        ...
        function changeObjFunction_Callback(this, hObject, ~)
            ...
            if ~strcmp(currentClass, classToCreate)
                ...
                if  (isfield(currentObj, 'penalty') || isa(currentObj, 'DoseObjectives.matRad_DoseObjective')) && ...
