...
if nargout > 1
    ...
    for i = 1:numel(apertureInfo.beam)
        for j = 1:apertureInfo.beam(i).numOfShapes
            ...
            timeLimL = diff(apertureInfo.arc.beam(i).DAOAngleBorders) / apertureInfo.deliveryConstraints.gantryRotationSpeed(2);
            timeLimU = diff(apertureInfo.arc.beam(i).DAOAngleBorders) / apertureInfo.deliveryConstraints.gantryRotationSpeed(1);
