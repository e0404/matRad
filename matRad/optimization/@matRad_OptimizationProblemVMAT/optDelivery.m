...
for i = 1:size(apertureInfo.beam, 2)
    if apertureInfo.arc.beam(i).isDAOBeam
        ...
        factorMURate    = apertureInfo.deliveryConstraints.monitorUnitRate(2) / apertureInfo.beam(i).shape(1).MURate;
        factorLeafSpeed = apertureInfo.deliveryConstraints.leafSpeed(2) / apertureInfo.beam(i).maxLeafSpeed;
        factorGantryRot = apertureInfo.deliveryConstraints.gantryRotationSpeed(2) / apertureInfo.beam(i).gantryRot;
        ...
        factorMURate = apertureInfo.deliveryConstraints.monitorUnitRate(1) / apertureInfo.beam(i).shape(1).MURate;
...
% gantry speed has to go low enough to accommodate a slowly-moving leaf. In
