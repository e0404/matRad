classdef matRad_OptimizationProblemDAO < matRad_OptimizationProblem
    ...
    methods
        ...
        function obj = matRad_OptimizationProblemDAO(backProjection, apertureInfo)
            ...
            % central chokepoint: accept aperture info saved by an older
            % matRad version, whatever route it reached the optimizer by
            obj.apertureInfo = matRad_upgradeApertureInfo(apertureInfo);
        end
