...
if ~isempty(jacobStruct_dos_bixel)
    ...
    for i = 1:numel(apertureInfo.beam)
        ...
        for j = 1:apertureInfo.beam(i).numOfShapes
            % first weight
            weightColumns = offset + j == j_sparse;
            doseColumns = apertureInfo.beam(i).bixelIndMap(ixWeight);
            jacobStructSparseVec(weightColumns) = jacobStructSparseVec(weightColumns) + ...
                sum(jacobStruct_dos_bixel(:, doseColumns), 2);
