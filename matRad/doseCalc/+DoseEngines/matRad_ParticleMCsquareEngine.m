...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    methods
        ...
        function this = matRad_ParticleMCsquareEngine(pln)
            ...
            if nargin > 0 
                if (isfield(pln,'bioModel')&& isfield(pln.bioModel,'quantityOpt')&& ...
                    (isequal(pln.bioModel.quantityOpt,'effect') ||...
                    isequal(pln.bioModel.quantityOpt,'RBExD')) && ...
                    strcmp(pln.radiationMode,'carbon'))
                this.calcBioDose = true;
                elseif strcmp(pln.radiationMode,'protons') && isfield(pln,'bioModel') && ...
                        isfield(pln.bioModel,'quantityOpt') && isequal(pln.bioModel.quantityOpt,'RBExD')...
                        && isequal(pln.bioModel.model,'constRBE')
