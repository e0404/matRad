...
% matRad_apertureDAOFlags Marks the beams whose apertures were optimized.
%
%   Only VMAT distinguishes DAO control points from interpolated ones; for
%   any other plan every beam counts as optimized.
%
% call:
