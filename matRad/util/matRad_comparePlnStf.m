...
% matRad_comparePlnStf compares the matRad pln struct with the matRad
% stf struct for matching parameterization.
%
% call:
...
%% check if steering information is available in plan from the beginning
