classdef MatRad_MCsquareConfig
    ...
    properties       
        ...
        %%% Input files
        CT_File =			'CT.mhd'				% Name of the CT file. Default: CT.mhd
        HU_Density_Conversion_File	= 'HU_Density_Conversion.txt'	% Name of the file containing HU to density conversion data. Default: HU_Density_Conversion.txt
        HU_Material_Conversion_File	= 'HU_Material_Conversion.txt'	% Name of the file containing HU to material conversion data. Default: HU_Material_Conversion.txt
        BDL_Machine_Parameter_File =  'IBA_Trento.txt'			% Name of the machine parameter file for the beam data library. Default: BDL.txt
        ...
        4D_Dose_Accumulation =	false		% Enable/Disable the dose accumulation for all 4D-CT phases. Default: False
        ...
        %%% Output parameters
        Output_Directory		= 'Outputs'	% Name of the output directory. Default: Outputs
        ...
        Export_Beam_dose =		'Disable' % Export dose distribution for each beam (Enable) or entire plan (Disable). Default: Disable
