        ...
        for j = 1:numel(cst{i,6})
            ...
            if ~isempty(strfind(cst{i,6}(j).type,'constraint'))
                ...
                if strcmp(cst{i,6}(j).robustness,'none')
                    ...
                    elseif isequal(type.bioOpt,'LEMIV_effect') && ~isempty(jacobVec)
                    ...
                    elseif isequal(type.bioOpt,'LEMIV_RBExD') && ~isempty(jacobVec)
...
if isequal(type.bioOpt,'LEMIV_effect') || isequal(type.bioOpt,'LEMIV_RBExD')
