classdef (Abstract) matRad_XBDLETObjective < matRad_XBDLETOptimizationFunction
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    methods %(Abstract)
        ...
        function fXBDLET       = computeXBDLETObjectiveFunction(obj,XBD_LET)
            error('Function needs to be implemented!');
        end
        
        
        %returns the dose-gradient for the given dose vector. Needs to be implemented in sub-classes.
        function fXBDLETGrad   = computeXBDLETObjectiveGradient(obj,XBD_LET)
            error('Function needs to be implemented!');
        end
    ...
    methods (Access = public)
        ...
        function obj = matRad_XBDLETObjective(varargin)
            %default initialization from struct (parameters & penalty)
            obj@matRad_XBDLETOptimizationFunction(varargin{:});
        end
        
        %Overloads the struct function to add Objective related information
        %to output struct
        function s = struct(obj)
            s = struct@matRad_XBDLETOptimizationFunction(obj);
