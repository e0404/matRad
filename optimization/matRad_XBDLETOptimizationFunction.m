classdef (Abstract) matRad_XBDLETOptimizationFunction
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    methods
        function obj = matRad_XBDLETOptimizationFunction(dataStruct)
    ...
    methods (Access = public)
        function doseParams = getXBDLETParameters(obj)
            % get only the dose related parameters.
            ix = cellfun(@(c) isequal('XBD(LET)',c),obj.parameterTypes);
            doseParams = [obj.parameters{ix}];
        end
        
        function obj = setXBDLETParameters(obj,doseParams)
