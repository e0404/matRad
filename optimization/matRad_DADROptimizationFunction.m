classdef (Abstract) matRad_DADROptimizationFunction
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    methods
        function obj = matRad_DADROptimizationFunction(dataStruct)
        ...
        function s = convertOldOptimizationStruct(old_s)
            ...
            switch old_s.type
                ...
                case 'square deviation'
                    s.className = 'DADRObjectives.matRad_SquaredDeviation';
                    s.penalty = old_s.penalty;
                    s.parameters{1} = old_s.dose;
                    
                case 'square overdosing'
                    s.className = 'DADRObjectives.matRad_SquaredOverdosing';
                    s.penalty = old_s.penalty;
                    s.parameters{1} = old_s.dose;
                    
                case 'square underdosing'
                    s.className = 'DADRObjectives.matRad_SquaredUnderdosing';
                    s.penalty = old_s.penalty;
                    s.parameters{1} = old_s.dose;
                    
                case 'min DVH objective'
                    s.className = 'DADRObjectives.matRad_MinDVH';
                    s.parameters{1} = old_s.dose;
                    s.parameters{2} = old_s.volume;
                        
                case 'max DVH objective'
                    s.className = 'DADRObjectives.matRad_MaxDVH';
                    s.parameters{1} = old_s.dose;
                    s.parameters{2} = old_s.volume;
                    
                case 'mean'
                    s.className = 'DADRObjectives.matRad_MeanDose';
                    s.parameters{1} = old_s.dose;
                    
                case 'EUD'
                    s.className = 'DADRObjectives.matRad_EUD';
                    s.parameters{1} = old_s.dose;
                    s.parameters{2} = old_s.EUD;
                    
                %Constraints
                case  'max dose constraint'
                    s.className = 'DADRConstraints.matRad_MinMaxDose';
                    s.parameters{1} = 0;
                ...
                case  'max mean dose constraint'
                    s.className = 'DADRConstraints.matRad_MinMaxMeanDose';
                    s.parameters{1} = 0;
                    s.parameters{2} = old_s.dose;
                    
                    
                case  'min EUD constraint'
                    s.className = 'DADRConstraints.matRad_MinMaxEUD';
                ...
                case  'max DVH constraint'
                    s.className = 'DADRConstraints.matRad_MinMaxDVH';
                    s.parameters{1} = old_s.dose;
                    s.parameters{2} = 0;
