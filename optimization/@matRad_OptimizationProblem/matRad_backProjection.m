function d = matRad_backProjection(optiProb,w,dij)
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%if isequal(w,matRad_global_x)
    ...
    %d = matRad_global_d;
%else
if ~isequal(w,optiProb.currentWeights)

    optiProb.currentWeights = w;
    
    d = cellfun(@(physDij) physDij*w,dij.physicalDose,'UniformOutput',false);
