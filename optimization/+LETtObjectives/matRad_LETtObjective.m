classdef (Abstract) matRad_LETtObjective < matRad_DoseOptimizationFunction
% matRad_LETtObjective: Interface for optimization objectives
%   This abstract base class provides the structure of optimization
%   objectives like mean LETt, squared deviation etc.
%   Implementations can be found in the LETtObjectives package
%
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   properties (Abstract, Access = public)
    ...
    methods (Access = public)
        ...
        function obj = matRad_LETtObjective(varargin)
