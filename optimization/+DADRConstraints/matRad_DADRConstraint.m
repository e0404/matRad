classdef (Abstract) matRad_DADRConstraint < matRad_DADROptimizationFunction
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    methods %(Abstract)
        ...
        function cDose        = computeDADRConstraintFunction(obj,dose)
        ...
        function cDoseJacob   = computeDADRConstraintJacobian(obj,dose)
          error('Function needs to be implemented!');
        end
    ...
    methods (Access = public)
        ...
        function obj = matRad_DADRConstraint(varargin)
            %default initialization from struct (parameters & penalty)
            obj@matRad_DADROptimizationFunction(varargin{:});
        end
        ...
        function s = struct(obj)
            s = struct@matRad_DADROptimizationFunction(obj);
        end
    end
end
