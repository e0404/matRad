...
for i = 1:size(cst,1)    
    for j = 1:numel(cst{i,6})
        ...
        elseif isequal(cst{i,6}(j).type, 'exact DVH constraint') ||...
            ...
            for k = j+1:numel(cst{i,6})
                if (isequal(cst{i,6}(k).type, 'exact DVH constraint') && isequal(cst{i,6}(i).dose,cst{i,6}(j).dose)) || ...
                   (isequal(cst{i,6}(k).type, 'exact DVH constraint') && isequal(cst{i,6}(i).volume,cst{i,6}(j).volume)) || ... 
                   (isequal(cst{i,6}(k).type, 'max DVH constraint')   && isequal(cst{i,6}(i).dose,cst{i,6}(j).dose)) || ...
            ...
            if ~isempty(strfind(cst{i,6}(j).type,'constraint'))
                ...
                if strcmp(cst{i,6}(j).robustness,'none')
                    ...
                    if isequal(cst{i,6}(j).type, 'max dose constraint') || ...
                       ...
                       jacobStruct = [jacobStruct; spones(mean(dij.physicalDose{1}(cst{i,4},:)))];
                ...
                elseif strcmp(cst{i,6}(j).robustness,'probabilistic') || strcmp(cst{i,6}(j).robustness,'voxel-wise worst case')
                    ...
                    for k = 1:dij.numOfScenarios
                        ...
                        if isequal(cst{i,6}(j).type, 'max dose constraint') || ...
                           ...
                           jacobStruct = [jacobStruct; spones(mean(dij.physicalDose{k}(cst{i,4},:)))];
