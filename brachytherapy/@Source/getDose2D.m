...
% r:        Column vector containing the (radial) distance from the source center to
%           P(r,theta), with units of cm.
% theta:    Column vector vector of polar angles between the longitudinal axis of the source
