...
if any(sameTdiffR)
    ...
    Phi_an(indInsideR(sameTdiffR)) = Q11+...
        ((Q12-Q11)./(obj.AnisotropyRadialDistances(ir2(sameTdiffR))-obj.AnisotropyRadialDistances(ir1(sameTdiffR)))').*(r(indInsideR(sameTdiffR))-obj.AnisotropyRadialDistances(ir1(sameTdiffR))');
end
%case 2
...
if any(sameRdiffT)
    ...
    Phi_an(indInsideR(sameRdiffT))= Q11+...
        ((Q12-Q11)./(obj.AnisotropyPolarAngles(it2(sameRdiffT))-obj.AnisotropyPolarAngles(it1(sameRdiffT)))).*(theta(indInsideR(sameRdiffT))-obj.AnisotropyPolarAngles(it1(sameRdiffT)));
end
%case 3
