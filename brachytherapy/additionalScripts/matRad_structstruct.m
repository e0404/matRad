...
%   Andrew (2021). Graphically display the 'branch' structure of a struct variable
%   (https://www.mathworks.com/matlabcentral/fileexchange/32879-graphically-display-the-branch-structure-of-a-struct-variable),
%   MATLAB Central File Exchange. Retrieved July 9, 2021. 

function matRad_structstruct(S)
