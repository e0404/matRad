classdef matRad_calcBrachyDoseTest < matlab.unittest.TestCase
    ...
    methods(Test)
        ...
        function getDistMtx(testCase)
            ...
            [funcDistanceMatrix,DistanceVector] = getDistanceMatrix(seedPoints,dosePoints);
            
            testCase.verifyEqual(funcDistanceMatrix.norm,verifyDistanceMatrix,'AbsTol',0.1)
        end
        ...
        function getThetMtx(testCase)
            ...
            [funcThetaMatrix,ThetaVector] = gemachine.data.SourceTypetThetaMatrix(SeedDirection,DistanceMatrix);
